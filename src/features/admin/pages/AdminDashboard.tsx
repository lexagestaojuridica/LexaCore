...
import {
    Building2, CreditCard, Users, TrendingUp, Activity, AlertCircle
} from "lucide-react";
    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-zinc-400 text-sm">Acompanhe o crescimento e a saúde da plataforma Lexanova em tempo real.</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className="bg-zinc-900 border-zinc-800">
                    ...
                    <CardContent className="px-5 pb-5">
                        ...
                        <p className="text-xs text-emerald-500 mt-1 flex items-center gap-1"><TrendingUp className="h-3 w-3" /> +17% em relação ao último mês</p>
                    </CardContent>
                </Card>
                <Card className="bg-zinc-900 border-zinc-800">
                    <CardHeader className="flex flex-row items-center justify-between pt-5 pb-2 px-5">
                    ...
                    <CardContent className="px-5 pb-5">
                        ...
                        <p className="text-xs text-zinc-500 mt-1">De {orgsCount ?? "..."} escritórios registrados</p>
                    </CardContent>
                </Card>
                <Card className="bg-zinc-900 border-zinc-800">
                    <CardHeader className="flex flex-row items-center justify-between pt-5 pb-2 px-5">
                    ...
                    <CardContent className="px-5 pb-5">
                        ...
                        <p className="text-xs text-sky-500 mt-1 flex items-center gap-1"><TrendingUp className="h-3 w-3" /> Crescimento constante</p>
                    </CardContent>
                </Card>
                <Card className="bg-zinc-900 border-zinc-800">
                    <CardHeader className="flex flex-row items-center justify-between pt-5 pb-2 px-5">
                    ...
                    <CardContent className="px-5 pb-5">
                        ...
                        <p className="text-xs text-zinc-500 mt-1">Zero erros reportados hoje</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
                <Card className="col-span-4 bg-zinc-900 border-zinc-800">
                    <CardHeader>
                        ...
                        <CardDescription className="text-zinc-500">Receita Recorrente Mensal (Últimos 6 meses)</CardDescription>
                    </CardHeader>
                    <CardContent className="h-[300px] w-full mt-4">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={mrrData}>
                                <XAxis dataKey="name" stroke="#52525b" fontSize={12} tickLine={false} axisLine={false} />
                                <YAxis stroke="#52525b" fontSize={12} tickLine={false} axisLine={false} tickFormatter={(value) => `R$${value / 1000}k`} />
                ...
                <Card className="col-span-3 bg-zinc-900 border-zinc-800 flex flex-col">
                    <CardHeader>
                        <CardTitle className="text-white flex items-center gap-2"><AlertCircle className="h-4 w-4 text-amber-500" /> Notificações do SaaS</CardTitle>
                        <CardDescription className="text-zinc-500">Monitoramento operacionais automáticos</CardDescription>
                    </CardHeader>
