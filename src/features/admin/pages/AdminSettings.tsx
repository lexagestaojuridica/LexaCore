...
export default function AdminSettings() {
    ...
    // Default fallback state if nothing is in DB
        ...
        <div className="flex flex-col gap-6 w-full max-w-4xl">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-zinc-400 text-sm">
                    Variáveis e interruptores que afetam toda a plataforma e inquilinos em tempo real.
                </p>
            </div>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
                <CardHeader className="pb-4">
                    ...
                    <CardDescription className="text-zinc-500">
                        Alterações nestas chaves entram em vigor imediatamente.
                    </CardDescription>
                </CardHeader>
                        ...
                        <>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-zinc-950/50 rounded-lg border border-zinc-800 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-zinc-500">Desconecta usuários e exibe a tela de manutenção. Somente Master Admins continuam com acesso.</p>
                                </div>
                                <Switch
                                    checked={settingsState.maintenance_mode}
                                    onCheckedChange={(c) => setSettingsState({ ...settingsState, maintenance_mode: c })}
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-zinc-950/50 rounded-lg border border-zinc-800 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-zinc-500">Oculta formulários de registro e impede a criação de novas contas/inquilinos até ser reativado.</p>
                                </div>
                                <Switch
                                    checked={settingsState.disable_new_signups}
                                    onCheckedChange={(c) => setSettingsState({ ...settingsState, disable_new_signups: c })}
                            ...
                            <div className="flex flex-col gap-3 p-4 bg-zinc-950/50 rounded-lg border border-zinc-800">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm text-zinc-500">Exibe uma faixa de alerta no topo do Dashboard para todos os usuários logados. Deixe em branco para remover.</p>
                                </div>
                                <Input
                                    value={settingsState.platform_notice}
                                    onChange={(e) => setSettingsState({ ...settingsState, platform_notice: e.target.value })}
                                    placeholder="Ex: Sistema passará por instabilidade hoje às 22h..."
                            ...
                            {settingsState.maintenance_mode && (
                                <div className="flex items-start gap-3 p-4 bg-rose-500/10 border border-rose-500/20 rounded-lg text-rose-400">
                                    ...
                                    <p className="text-sm">
                                        <strong>Cuidado!</strong> Ao salvar em Modo de Manutenção, qualquer usuário que não tenha Role de admin será bloqueado de interagir com o SaaS imediatamente.
                                    </p>
                                </div>
                            )}
                        </>
