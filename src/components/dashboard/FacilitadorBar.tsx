...
import {
    ChevronDown, ChevronUp, Plus, GripVertical, X, ExternalLink, Pencil, RotateCcw,
} from "lucide-react";
                                        ...
                                        <Tooltip key={link.id} delayDuration={200}>
                                            <TooltipTrigger asChild>
                                                <a
                                                    ...
                                                    className="group flex items-center gap-1.5 rounded-md px-2 py-1 text-xs text-muted-foreground hover:bg-muted hover:text-foreground transition-all whitespace-nowrap"
                                                >
                        ...
                        <Tooltip delayDuration={0}>
                            <TooltipTrigger asChild>
                                <button
                                    ...
                                    className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-muted-foreground/50 hover:bg-muted hover:text-foreground transition-all"
                                >
