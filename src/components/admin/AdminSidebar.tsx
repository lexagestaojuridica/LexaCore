...
const adminNavItems = [
    {
        title: "Executivo (SaaS)",
        url: "/admin/hq",
        icon: BarChart3,
    },
    {
        title: "Escritórios & Clientes",
        url: "/admin/hq/organizations",
        icon: Building2,
    },
    {
    ...
    },
    {
        ...
        url: "/admin/hq/support",
        icon: Headset,
    },
    {
        title: "Configurações Globais",
        url: "/admin/hq/settings",
        icon: Settings,
    },
];
    ...
    return (
        <Sidebar collapsible="icon" className="bg-zinc-950 border-r border-zinc-900">
            ...
            <div className="flex h-14 shrink-0 items-center justify-center border-b border-zinc-900 px-3 bg-zinc-950">
                {collapsed ? (
                    <img src={iconLexa} alt="LEXA" className="h-8 w-8 object-contain opacity-80" />
                ) : (
                    <div className="flex items-center gap-2">
                        <img src={iconLexa} alt="LEXA" className="h-6 w-6 object-contain" />
            ...
            <SidebarFooter className="shrink-0 border-t border-zinc-900 p-3 bg-zinc-950">
                <Tooltip delayDuration={0}>
                    <TooltipTrigger asChild>
                        <a
                            href="/dashboard"
                            className="flex items-center gap-2 rounded-md px-3 py-2 text-[13px] text-zinc-400 font-medium transition-all hover:bg-zinc-900 hover:text-white"
                        >
